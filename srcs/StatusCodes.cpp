...
{
    m_status_codes = initStatusCodes();
}

StatusCodes::StatusCodes(const StatusCodes &copy)
{
...
StatusCodes & StatusCodes::operator=(const StatusCodes &copy)
{
	if (this != &copy)
		*this = copy;
	return (*this);
...
std::map<int, std::string>      StatusCodes::getStatusCodesMap()
{
	return (m_status_codes);
}

std::map<int, std::string>		StatusCodes::initStatusCodes()
{
